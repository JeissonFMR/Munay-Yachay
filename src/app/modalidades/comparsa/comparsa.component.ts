...
@Component({
  selector: 'app-comparsa',
  templateUrl: './comparsa.component.html',
  styles: []
})
export class ComparsaComponent implements OnInit {
  ...
  lineChartData: Array<any> = [
    { data: [0, 99, 385, 200, 129, 189, 141], label: 'Participantes' }
  ];
