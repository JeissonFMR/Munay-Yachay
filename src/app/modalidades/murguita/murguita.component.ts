...
@Component({
  selector: 'app-murguita',
  templateUrl: './murguita.component.html',
  styles: []
})
export class MurguitaComponent implements OnInit {
  ...
  lineChartData: Array<any> = [
    { data: [0, 51, 203, 139, 238, 195, 112], label: 'Participantes' }
  ];
