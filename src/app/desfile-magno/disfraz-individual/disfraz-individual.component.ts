...
@Component({
  ...
  styleUrls: ['./disfraz-individual.component.scss']
})
export class DisfrazIndividualComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.imagenesGaleria = [
      {
        Img: '../../../assets/img/desfile-magno/disfraz-individual/IMG_20230103_141913.jpg',
        alt: 'Imagen 1'
      },
      {
        Img: '../../../assets/img/desfile-magno/disfraz-individual/IMG_20230106_122027.jpg',
        alt: 'Imagen 2'
      },
