...
@Component({
  selector: 'app-carroza-no-motori',
  templateUrl: './carroza-no-motori.component.html',
  styleUrls: ['./carroza-no-motori.component.scss']
})
export class CarrozaNoMotoriComponent implements OnInit {
